...
class Pymodoro:
    ...
    def build_buttons(self):
        button_frames = tkinter.Frame(self.main_frame)
        button_frames.grid(row = 2, column = 0,
            sticky = 'nsew',
            padx = 10, pady = 10
        )
        button_frames.columnconfigure(0, weight = 1)
        button_frames.columnconfigure(1, weight = 1)
        self.start_button = tkinter.Button(button_frames, text = 'Start', command = self.start_timer)
        self.stop_button = tkinter.Button(button_frames, text = 'Stop', command = self.stop_timer)
